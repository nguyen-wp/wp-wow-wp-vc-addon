...
vc_add_shortcode_param( 'wow_vc_group_header', 'wow_vc_header' );

function wow_vc_header( $settings, $value ) {
...
vc_add_shortcode_param( 'wow_vc_hidden_frm', 'wow_vc_hidden_f' );

function wow_vc_hidden_f( $settings, $value ) {
    
    return '<input name="' . $settings['param_name'] . '" class="wow_vc_hidden_frm wpb_vc_param_value wpb-textinput ' . $settings['param_name'] . ' ' . $settings['type'] . '" type="hidden" value=""/>';

}
vc_add_shortcode_param( 'wow_vc_disable_frm_id_gen', 'wow_vc_disable_frm_id_gen' );

function wow_vc_disable_frm_id_gen( $settings, $value ) {
    
    return '<input name="' . $settings['param_name'] . '" class="wow_vc_disable_frm_id_gen wpb_vc_param_value wpb-textinput ' . $settings['param_name'] . ' ' . $settings['type'] . '" type="text" value="'.$value.'"/>';

}
vc_add_shortcode_param( 'wow_vc_hidden_frm_button', 'wow_vc_hidden_frm_button' );

function wow_vc_hidden_frm_button( $settings, $value ) {
    
    return '<button name="' . $settings['param_name'] . '" class="wow_vc_hidden_frm_button wpb_vc_param_value vc_general vc_ui-button-shape-rounded vc_ui-button vc_ui-button-action ' . $settings['param_name'] . ' ' . $settings['type'] . '" value="'.$value.'" type="button" />'.$value.'</button>';

}



add_filter( 'vc_iconpicker-type-iconsmind', 'wow_vc_iconpicker_type_iconsmind' );
/**
 * Add iconsmind icon family into page builder.
 *
 * @since 1.0
 */
function wow_vc_iconpicker_type_iconsmind( $icons ) {
	$iconsmind_icons = array(
		...
		array("iconsmind-weight-wow" => "iconsmind-weight-wow"), 
...
add_filter( 'vc_iconpicker-type-steadysets', 'wow_vc_iconpicker_type_steadysets' );
 ...
 * @since 1.0
 */
function wow_vc_iconpicker_type_steadysets( $icons ) {
...
add_filter( 'vc_iconpicker-type-linea', 'wow_vc_iconpicker_type_linea' );
 ...
 * @since 1.0
 */
function wow_vc_iconpicker_type_linea( $icons ) {
	$linea_icons = array(
