...
// $output .= '<section'. $block_id .' class="wow-vc-elements wow-vc-' . $this->name . $theme . $css_class .$classname.''.($add_box_button ? ' wow-vc-hold-click' : '').$initial_loading_animation.'"' . str_replace('``', '', $attribute) . '>';
